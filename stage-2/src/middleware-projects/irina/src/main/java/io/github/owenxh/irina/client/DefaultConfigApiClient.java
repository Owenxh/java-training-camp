...
public class DefaultConfigApiClient implements ConfigApi {
    ...
    private final Predicate<Config> configValidator;

    @SafeVarargs
    public DefaultConfigApiClient(String serverEndpoint, Predicate<Config>... configValidators) {
    ...
    private void validateConfig(Config config) {
        if (config != null && !configValidator.test(config)) {

...
public class Config {
    ...
    public void checksum(Algorithm algorithm) {
        this.checksum = Checksum.of(algorithm, this::contentAsBytes);
    }
    ...
    public Map<String, String> unmarshall() {
        ...
        try {
           return this.type.unmarshall(this.content);
            ...
            throw new RuntimeException("Parse content error", e);
        }
    }
    ...
    public Config transform(Type targetType) {
        ...
        try {
            ...
            throw new RuntimeException("Transformer content error", e);
        }

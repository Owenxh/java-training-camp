package com.acme.middleware.rpc.plugin.seata.client;

import com.acme.middleware.rpc.InvocationRequest;
import com.acme.middleware.rpc.client.RpcClientExecution;
import com.acme.middleware.rpc.client.RpcServerInterceptor;
...
/**
 * Seata transaction propagation {@link RpcServerInterceptor}
 *
 ...
 * @since 1.0
 */
public class TransactionPropagationClientInterceptor implements RpcServerInterceptor {

    private static final Logger log = LoggerFactory.getLogger(TransactionPropagationClientInterceptor.class);

    @Override
    public Object intercept(@NotNull InvocationRequest request, @NotNull RpcClientExecution execution) {
    ...
    private static class MetadataWrapper {
        ...
        private String resolveKey(String key) {
            return TransactionPropagationClientInterceptor.class.getName() + '.' + key;
        }
